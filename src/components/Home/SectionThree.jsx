                  ...
                  >
                    <div className="flex md:flex-row flex-col items-center gap-0 md:gap-3 ">
                      <img
                        ...
                        alt={blog.title}
                        className="md:w-96 overflow-hidden w-full md:h-60 h-full object-cover md:rounded-md hover:scale-105 duration-200 transition-all ease-out hover:opacity-70"
                      />
